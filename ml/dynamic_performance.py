...
# /groups/ilabt-imec-be/software-performance/changedistiller/projectA/commons-csv/
path1 = '/groups/ilabt-imec-be/software-performance/changedistiller/projectA/commons-csv/'
path2 = '/groups/ilabt-imec-be/software-performance/changedistiller/projectB/commons-csv/'
...
def read_dataset(path_resources, path_trace, path_jvm, path_changedistiller):
    # resources
    df_res = pd.read_csv(path_resources, sep=';', header=None)
    ...
    df_trace = pd.read_csv(path_trace, sep=';', header=None)
    ...
    df_jvm = pd.read_csv(path_jvm, sep=';', header=None)
    ...
    df_cd = pd.read_csv(path_changedistiller, sep=',')
...
def print_results(model, cols, X_train, y_test, yhat):
    # confusion matrix
...
def knearest_neighbor(X, y, cols):
    print('knn')
    # data = dataset.values
    ...
    X_train, y_train, X_test, y_test = prepare_dataset(X, y, cols)
    ...
    print_results(model, cols, X_train, y_test, yhat)
...
def logistic_regression(X, y, cols):
...
def main():
    print('starting...')
    path_resources = '../data/resources/csv-resources-avg.csv'
    path_trace = '../data/trace/csv-own_dur_trace.csv'
    path_jvm = '../data/jvm/csv-jvms-avg.csv'
    path_changedistiller = '../data/changedistiller/commons-csv-results.csv'

    df = read_dataset(path_resources, path_trace, path_jvm, path_changedistiller)
